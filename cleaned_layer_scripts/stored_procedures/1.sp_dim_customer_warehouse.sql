-- =============================================
-- Stored Procedure: Create Customer Dimension in Warehouse
-- Purpose: This procedure creates the cleaned customer dimension table
--          in the data warehouse by copying and cleaning data from staging.
-- Level: Beginner-friendly with detailed explanations
-- =============================================

CREATE OR ALTER PROCEDURE sp_create_dim_customer_warehouse
AS
BEGIN
    ...
    -- This prevents errors if we run the procedure multiple times
    ...
    PRINT 'Customer dimension procedure completed successfully!';
END;
GO